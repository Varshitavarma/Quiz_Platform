...
mysql -u $DB_USER -p$DB_PASS -D $DB_NAME -e "create table $quiz_name (sno int auto_increment, question varchar(255) not null, option1 varchar(255) not null, option2 varchar(255) not null, option3 varchar(255) not null, option4 varchar(255) not null, primary key (sno) )"
i=1
...
mysql -u $DB_USER -p$DB_PASS -D $DB_NAME -e "insert into $quiz_name values('$i','$question','$option1','$option2','$option3','$option4')"
